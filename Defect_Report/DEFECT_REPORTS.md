| D-API-001 | GET /products returns HTTP 500 | REQ-API-Products-001 | A10: Mishandling of Exceptional Conditions | High | Medium | Open | https://github.com/AbdulhameedTiman55/Scoops2Go/issues/1 |


| D-API-002 | Duplicate products allowed | REQ-API-Products-002 |  | Medium | Medium | Open | https://github.com/AbdulhameedTiman55/assessment/issues/2 |
